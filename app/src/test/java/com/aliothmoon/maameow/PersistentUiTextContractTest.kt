...
class PersistentUiTextContractTest {
    ...
    companion object {
        private val TARGETS = listOf(
            TargetFile(
                "src/main/java/com/aliothmoon/maameow/ui/state/HomeUiState.kt",
            ...
            TargetFile(
                "src/main/java/com/aliothmoon/maameow/ui/screen/panel/FloatingPanelState.kt",
                forbiddenPatterns = listOf(
            ...
            TargetFile(
                "src/main/java/com/aliothmoon/maameow/ui/viewmodel/ToolboxViewModel.kt",
                forbiddenPatterns = listOf(
            ...
            TargetFile(
                "src/main/java/com/aliothmoon/maameow/ui/viewmodel/SettingsViewModel.kt",
                forbiddenPatterns = listOf(
