...
fun SettingsViewMiuix(
    navController: NavController, onViewAnnouncement: () -> Unit, viewModel: SettingsViewModel, resourceInitService: ResourceInitService, logExportService: LogExportService
) {
