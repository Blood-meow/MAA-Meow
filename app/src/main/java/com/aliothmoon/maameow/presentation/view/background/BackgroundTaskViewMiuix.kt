    ...
    Box(modifier = Modifier.fillMaxSize()) {
        ...
        activeDialog?.let { dialog ->
            ...
            val confirmColor = when (dialog.type) {
                PanelDialogType.SUCCESS -> colorScheme.primary
                PanelDialogType.WARNING -> colorScheme.tertiary
                PanelDialogType.ERROR -> colorScheme.error
            }
            ...
            Column(modifier = Modifier.padding(10.dp)) {
                ...
                Row(
                    ...
                    ActionTile(
                        ...
                        modifier = Modifier.weight(1f),
                        containerColor = if (isGameMuted) colorScheme.tertiary else colorScheme.secondary,
                        contentColor = if (isGameMuted) colorScheme.tertiary else colorScheme.onSurface
                    )
                }
