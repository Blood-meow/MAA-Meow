...
/**
 * Liquid glass lens refraction effect.
 * Creates a frosted-glass-like refraction on the edges of a rounded shape.
 *
 * @param refractionHeight How far from the edge the refraction extends (px)
 * @param refractionAmount How strong the refraction displacement is (px)
 * @param depthEffect Whether to add a depth-based displacement towards center
 * @param chromaticAberration Color fringing intensity (0 = disabled)
 */
