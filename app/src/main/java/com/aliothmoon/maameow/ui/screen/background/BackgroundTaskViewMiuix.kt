            ...
            Column(modifier = Modifier.padding(10.dp)) {
                ...
                Row(
                    ...
                    ActionTile(
                        ...
                        modifier = Modifier.weight(1f),
                        containerColor = if (isGameMuted) MiuixTheme.colorScheme.secondary else MiuixTheme.colorScheme.secondary,
                        contentColor = if (isGameMuted) MiuixTheme.colorScheme.onSecondaryVariant else MiuixTheme.colorScheme.onSurface
                    )
                }
